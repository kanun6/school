...
const NewsCard = ({ imgSrc, title, date }: { imgSrc: string, title: string, date: string }) => (
  <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden group">
    <img src={imgSrc} alt={title} className="w-full h-40 object-cover group-hover:scale-105 transition-transform duration-300" />
    <div className="p-5">
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-900 text-gray-800 dark:text-gray-200">
      ...
      <section className="bg-white dark:bg-gray-800 py-20">
         <div className="container mx-auto px-6">
            <div className="text-center mb-12">
                <h2 className="text-3xl font-bold tracking-tight text-gray-900 dark:text-white">ข่าวสารและประกาศ</h2>
                <p className="mt-2 text-md text-gray-500 dark:text-gray-400">ติดตามข่าวสารล่าสุดและประกาศสำคัญจากทางโรงเรียน</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <NewsCard imgSrc="https://placehold.co/600x400/a7f3d0/1c1917?text=ประกาศ" title="ประกาศเลื่อนสอบปลายภาค" date="15 พฤษภาคม 2567" />
                <NewsCard imgSrc="https://placehold.co/600x400/fecaca/1c1917?text=กิจกรรม" title="ประกาศวันหยุดทำการเรียน" date="10 พฤษภาคม 2567" />
                <NewsCard imgSrc="https://placehold.co/600x400/bae6fd/1c1917?text=ข่าวสาร" title="ประกาศผลการเรียนใหม่" date="7 พฤษภาคม 2567" />
            </div>
         </div>
      </section>
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
            <div className="bg-blue-600 rounded-lg shadow-xl p-12 text-center text-white">
                <h2 className="text-3xl font-bold">พร้อมสำหรับอนาคตของการจัดการโรงเรียนหรือยัง?</h2>
                <p className="mt-4 max-w-2xl mx-auto">เข้าร่วมกับเราและยกระดับการบริหารจัดการโรงเรียนของคุณไปอีกขั้น</p>
                <div className="mt-8">
                    <Link href="/signup" className="inline-block px-8 py-3 border border-transparent text-base font-medium rounded-md text-blue-600 bg-white hover:bg-gray-100 transition-colors">
                        ลงทะเบียนใช้งานฟรี
                    </Link>
                </div>
            </div>
